...
gst-launch-1.0 filesrc location=~/bbb_sunflower_2160p_60fps_normal.mp4 num-buffers=$TotalFrame ! qtdemux ! queue ! h264parse ! queue ! vaapih264dec  ! queue ! vaapih264enc bitrate=8000 ! matroskamux ! filesink location=sample_ouput_gpu.mkv -e > /tmp/gst.log
