...
if [ "${MODEL_DIR}" == "" ]; then
	...
	python3 /opt/intel/openvino_2021/deployment_tools/open_model_zoo/tools/downloader/downloader.py --name ${MODEL} -o ${CUR_DIR}/models/ 2>/dev/null || echo -e "\e[0;32m ========== Benchmark models download and extract completed =========== \e[0m"
else
