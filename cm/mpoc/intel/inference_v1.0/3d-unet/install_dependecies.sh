...
sudo apt update
sudo apt-get install -y libglib2.0-dev libtbb-dev python3-dev python3-pip python3-venv unzip python3.8-venv libssl-dev libgtk-3-dev shellcheck
...
#   Build loadgen
#===============================================================
MLPERF_INFERENCE_REPO=${DEPS_DIR}/3d-unet_inference
echo ${SKIPS}
