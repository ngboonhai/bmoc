...
cd $INFERENCE_NVIDIA_PATH
make run RUN_ARGS="--benchmarks=rnnt --scenarios=SingleStream --test_mode=PerformanceOnly"
make run RUN_ARGS="--benchmarks=rnnt --scenarios=Offline --test_mode=PerformanceOnly"