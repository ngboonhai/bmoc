...
decode_cmd="gst-launch-1.0 filesrc location=~/bbb_sunflower_2160p_60fps_normal.mp4 num-buffers=$TotalFrame ! qtdemux ! queue ! h264parse ! queue ! vaapih264dec ! queue ! qtmux ! perf ! filesink location=sample_output_vaapi_h264_decode.mp4 -e"
TotalFrame=1000
